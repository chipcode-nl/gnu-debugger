...
@file
@copyright   Chipcode, all rights reserved
...
export class GnuDebugSession extends DebugSession {
	...
	private serverResolve: (value: any) => void;
	...
	private clientResolve: (value: any) => void;
